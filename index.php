...
//get the username and password  from the form and compare to the predefines username and password
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      				...
		      				echo "<div class='alert alert-warning' role='alert'> 
		      							You are still logged in. Please <a href='account.php'> click here </a> to proceed. </div>";
